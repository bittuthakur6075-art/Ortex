...
export default function Portfolio() {
  ...
  const portfolioItems = [
    ...
    },
    {
      ...
      category: "MDF Wall Art & Signages",
    ...
    },
    {
      ...
      category: "Highlighters & Stationery",
          ...
          <AnimatePresence mode="popLayout">
            {filteredItems.map((item, idx) => (
              <motion.div 
                ...
                className="gallery-card group cursor-pointer flex flex-col h-full rounded-xl bg-card border border-border/50 shadow-sm hover:shadow-xl transition-all duration-300 text-left"
              >
