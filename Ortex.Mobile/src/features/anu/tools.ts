...
export const ANU_TOOLS = [
  {
    functionDeclarations: [
      ...
      {
        name: "open_record",
        description: "Show a record on screen once the call ends: a customer, enquiry, Anu call, quotation or product. Say you are opening it, then call end_call.",
        parameters: {
          type: "OBJECT",
          properties: {
      ...
      {
        name: "end_call",
        description: "Hang up after a short goodbye, or right after saying you are opening a record or a draft.",
      },
    ],
  },
]
