...
const SIZES: Record<ButtonSize, { height: number; paddingHorizontal: number; fontSize: number; iconSize: number }> = {
    ...
    >
      {loading ? (
        ...
        <View style={styles.content}>
          ...
          <Text
            numberOfLines={1}
            style={[styles.label, { color: tones.text, fontSize: dims.fontSize }]}
          >
            {label}
          </Text>
        </View>
