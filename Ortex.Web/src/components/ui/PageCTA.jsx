 ...
 * FinalCTA: dark primary band, content-left / equal-width pill buttons on the
 * right, 80px vertical padding. Keeps every page's call-to-action identical.
 */
      ...
      <div className="lp-wrap">
        ...
        >
          <div className="lg:max-w-2xl">
            ...
            {children && (
              <p className="text-[16px] font-normal max-w-2xl text-primary-foreground/90">{children}</p>
            )}
          </div>
