...
const TABS = [
  { value: "growth", moduleKey: "growth", label: "Growth", icon: TrendingUp, Page: Growth },
...
export default function Insights() {
  ...
  return (
    <div>
      <PageHeader title="Growth" subtitle="Visitor-to-cash funnel, attribution and the website event stream" />
      <Tabs
        className="mb-5"
        items={items}
        value={current.value}
